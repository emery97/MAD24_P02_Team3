...
public class TransferTicketsAdapter extends RecyclerView.Adapter<TransferTicketsAdapter.ViewHolder> {
    ...
    public TransferTicketsAdapter(List<BookingDetails> upcomingConcertsList) {
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View view) {
            ...
            transferTicketsButton = view.findViewById(R.id.transferTickets); // Ensure the ID matches
