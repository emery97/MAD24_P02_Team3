...
## Bottom Sheet (KOH YE CHYANG)
### Implementation at Forum Page
- Displaying comment section for each forum post.
- Providing user with live upates for the post and the comment ensuring consistency and accuracy.
- Ensuring smooth and accessbile experience for users
